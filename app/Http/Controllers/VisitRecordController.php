...
class VisitRecordController extends Controller
{
    ...
    public function statistic(){
        $daily_adult_click = VisitRecord::where('key', 'visit_count.adult')->whereDate('created_at', DB::raw('DATE(NOW())'))->first()->count;
        $daily_non_adult_click = VisitRecord::where('key', 'visit_count.non_adult')->whereDate('created_at', DB::raw('DATE(NOW())'))->first()->count;
